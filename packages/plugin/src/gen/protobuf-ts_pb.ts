...
// that are interpreted by @console-pbts/plugin.
//
...
/**
 * The available client styles that can be generated by @console-pbts/plugin
 *
...
export enum ClientStyle {
  ...
  /**
   * Use the generic implementations of @console-pbts/runtime-rpc.
...
/**
 * The available server styles that can be generated by @console-pbts/plugin
 *
...
export enum ServerStyle {
   ...
   * Adapters be used to serve the service, for example @console-pbts/grpc-backend
   * for gRPC.
   *
