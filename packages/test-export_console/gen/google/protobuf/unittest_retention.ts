 ...
 */
export const Service = new ServiceType("protobuf_unittest.Service", [], { "protobuf_unittest.service_option": { plainField: 1, runtimeRetentionField: 2, sourceRetentionField: 3 } });
