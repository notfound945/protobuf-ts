...
class GetPrivatePersonInfoReq$Type extends MessageType<GetPrivatePersonInfoReq> {
    ...
    create(value?: PartialMessage<GetPrivatePersonInfoReq>): GetPrivatePersonInfoReq {
        const message = globalThis.Object.create((this.messagePrototype!));
        message.personId = "";
        if (value !== undefined)
            reflectionMergePartial<GetPrivatePersonInfoReq>(this, message, value);
        return message;
    }
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: GetPrivatePersonInfoReq): GetPrivatePersonInfoReq {
        let message = target ?? this.create(), end = reader.pos + length;
        while (reader.pos < end) {
            let [fieldNo, wireType] = reader.tag();
            switch (fieldNo) {
    ...
    internalBinaryWrite(message: GetPrivatePersonInfoReq, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        /* string personId = 1; */
        if (message.personId !== "")
            writer.tag(1, WireType.LengthDelimited).string(message.personId);
        let u = options.writeUnknownFields;
...
class GetPrivatePersonInfoResp$Type extends MessageType<GetPrivatePersonInfoResp> {
    ...
    create(value?: PartialMessage<GetPrivatePersonInfoResp>): GetPrivatePersonInfoResp {
        const message = globalThis.Object.create((this.messagePrototype!));
        if (value !== undefined)
            reflectionMergePartial<GetPrivatePersonInfoResp>(this, message, value);
        return message;
    }
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: GetPrivatePersonInfoResp): GetPrivatePersonInfoResp {
        let message = target ?? this.create(), end = reader.pos + length;
        while (reader.pos < end) {
            let [fieldNo, wireType] = reader.tag();
            switch (fieldNo) {
                case /* PrivatePerson privatePerson */ 1:
                    message.privatePerson = PrivatePerson.internalBinaryRead(reader, reader.uint32(), options, message.privatePerson);
                    break;
                default:
                    let u = options.readUnknownField;
                    if (u === "throw")
    ...
    internalBinaryWrite(message: GetPrivatePersonInfoResp, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        /* PrivatePerson privatePerson = 1; */
        if (message.privatePerson)
            PrivatePerson.internalBinaryWrite(message.privatePerson, writer.tag(1, WireType.LengthDelimited).fork(), options).join();
        let u = options.writeUnknownFields;
        if (u !== false)
            (u == true ? UnknownFieldHandler.onWrite : u)(this.typeName, message, writer);
        return writer;
...
class GetEmbeddedMessageWithEnumReq$Type extends MessageType<GetEmbeddedMessageWithEnumReq> {
    ...
    create(value?: PartialMessage<GetEmbeddedMessageWithEnumReq>): GetEmbeddedMessageWithEnumReq {
        const message = globalThis.Object.create((this.messagePrototype!));
        message.name = "";
        message.day = 0;
        if (value !== undefined)
            reflectionMergePartial<GetEmbeddedMessageWithEnumReq>(this, message, value);
        return message;
    }
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: GetEmbeddedMessageWithEnumReq): GetEmbeddedMessageWithEnumReq {
        let message = target ?? this.create(), end = reader.pos + length;
        while (reader.pos < end) {
            let [fieldNo, wireType] = reader.tag();
            switch (fieldNo) {
                case /* string name */ 1:
                    message.name = reader.string();
                    break;
                case /* GetEmbeddedMessageWithEnumReq.Day day */ 2:
                    message.day = reader.int32();
                    break;
                case /* GetEmbeddedMessageWithEnumReq.WeatherInfo weatherInfo */ 3:
                    message.weatherInfo = GetEmbeddedMessageWithEnumReq_WeatherInfo.internalBinaryRead(reader, reader.uint32(), options, message.weatherInfo);
                    break;
                case /* Address address */ 4:
                    message.address = Address.internalBinaryRead(reader, reader.uint32(), options, message.address);
                    break;
                default:
                    let u = options.readUnknownField;
    ...
    internalBinaryWrite(message: GetEmbeddedMessageWithEnumReq, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        /* string name = 1; */
        if (message.name !== "")
            writer.tag(1, WireType.LengthDelimited).string(message.name);
        /* GetEmbeddedMessageWithEnumReq.Day day = 2; */
        if (message.day !== 0)
            writer.tag(2, WireType.Varint).int32(message.day);
        /* GetEmbeddedMessageWithEnumReq.WeatherInfo weatherInfo = 3; */
        if (message.weatherInfo)
            GetEmbeddedMessageWithEnumReq_WeatherInfo.internalBinaryWrite(message.weatherInfo, writer.tag(3, WireType.LengthDelimited).fork(), options).join();
        /* Address address = 4; */
        if (message.address)
...
class GetEmbeddedMessageWithEnumResp$Type extends MessageType<GetEmbeddedMessageWithEnumResp> {
    ...
    create(value?: PartialMessage<GetEmbeddedMessageWithEnumResp>): GetEmbeddedMessageWithEnumResp {
        const message = globalThis.Object.create((this.messagePrototype!));
        if (value !== undefined)
            reflectionMergePartial<GetEmbeddedMessageWithEnumResp>(this, message, value);
        return message;
    }
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: GetEmbeddedMessageWithEnumResp): GetEmbeddedMessageWithEnumResp {
        let message = target ?? this.create(), end = reader.pos + length;
        while (reader.pos < end) {
            let [fieldNo, wireType] = reader.tag();
            switch (fieldNo) {
                case /* Address address */ 1:
                    message.address = Address.internalBinaryRead(reader, reader.uint32(), options, message.address);
                    break;
                case /* GetEmbeddedMessageWithEnumResp.Msg msg */ 2:
                    message.msg = GetEmbeddedMessageWithEnumResp_Msg.internalBinaryRead(reader, reader.uint32(), options, message.msg);
                    break;
                default:
                    let u = options.readUnknownField;
                    if (u === "throw")
    ...
    internalBinaryWrite(message: GetEmbeddedMessageWithEnumResp, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        /* Address address = 1; */
        if (message.address)
            Address.internalBinaryWrite(message.address, writer.tag(1, WireType.LengthDelimited).fork(), options).join();
        /* GetEmbeddedMessageWithEnumResp.Msg msg = 2; */
        if (message.msg)
            GetEmbeddedMessageWithEnumResp_Msg.internalBinaryWrite(message.msg, writer.tag(2, WireType.LengthDelimited).fork(), options).join();
        let u = options.writeUnknownFields;
        if (u !== false)
            (u == true ? UnknownFieldHandler.onWrite : u)(this.typeName, message, writer);
        return writer;
